...
cat << "EOF"
              ...
              🟔           For OC NDK Branch and NDKBootPicker          🟔
              🟔                                                        🟔
              🟔                     Release Version                    🟔
              🟔                          1.0.0                         🟔  
              🟔                                                        🟔
...
### =============================== Repos ===================================== ###
Acqua() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/Acqua.7z > "${TMPDBG}"/Acqua.7z
unar "${TMPDBG}"/Acqua.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

Black() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/Black.7z > "${TMPDBG}"/Black.7z
unar "${TMPDBG}"/Black.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

DarkGray() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/DarkGray.7z > "${TMPDBG}"/DarkGray.7z
unar "${TMPDBG}"/DarkGray.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

NotWhite() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/NotWhite.7z > "${TMPDBG}"/NotWhite.7z
unar "${TMPDBG}"/NotWhite.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

NotWhite2() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/NotWhite_v2.7z > "${TMPDBG}"/NotWhite_v2.7z
unar "${TMPDBG}"/NotWhite_v2.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

Ochre() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/Ochre.7z > "${TMPDBG}"/Ochre.7z
unar "${TMPDBG}"/Ochre.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

OCTheme() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/OpenCore.7z  > "${TMPDBG}"/OpenCore.7z
unar "${TMPDBG}"/OpenCore.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

Red() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/Red.7z > "${TMPDBG}"/Red.7z
unar "${TMPDBG}"/Red.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

SilverDark() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/SilverDark.7z > "${TMPDBG}"/SilverDark.7z
unar "${TMPDBG}"/SilverDark.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

SilverLight() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/SilverLight.7z > "${TMPDBG}"/SilverLight.7z
unar "${TMPDBG}"/SilverLight.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

SilverSexy() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/SilverSexy.7z > "${TMPDBG}"/SilverSexy.7z
unar "${TMPDBG}"/SilverSexy.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

SilverViolet() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/SilverViolet.7z > "${TMPDBG}"/SilverViolet.7z
unar "${TMPDBG}"/SilverViolet.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

Velvet() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/Velvet.7z > "${TMPDBG}"/Velvet.7z
unar "${TMPDBG}"/Velvet.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

Steel() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/Abstract.Steel.7z > "${TMPDBG}"/Abstract.Steel.7z
unar "${TMPDBG}"/Abstract.Steel.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

Cushion() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/Cushion.Orange_v2.7z > "${TMPDBG}"/Cushion.Orange_v2.7z
unar "${TMPDBG}"/Cushion.Orange_v2.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

CushionG() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/Cushion.Gray.7z > "${TMPDBG}"/Cushion.Gray.7z
unar "${TMPDBG}"/Cushion.Gray.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

CushionB() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/Cushion.Bluey.7z > "${TMPDBG}"/Cushion.Bluey.7z
unar "${TMPDBG}"/Cushion.Bluey.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

Marbles() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/Marbles.7z > "${TMPDBG}"/Marbles.7z
unar "${TMPDBG}"/Marbles.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}

BloodyCushion() {
curl -qsSLk https://github.com/LAbyOne/OpenCoreThemes/releases/download/Releases/BloodyCushion.7z > "${TMPDBG}"/BloodyCushion.7z
unar "${TMPDBG}"/BloodyCushion.7z -o "${TMPDBG}" && rm -r "${TMPDBG}"/*.7z && open "${TMPDBG}"
}
...
echo "
                "
options=( '🔵 Screenshots' '⭕ Acqua' '⭕ Black' '⭕ DarkGray' '⭕ NotWhite' '⭕ NotWhite2      ' '⭕ Ochre' '⭕ OpenCore      ' '⭕ Red' '⭕ SilverDark' '⭕ SilverLight' '⭕ SilverSexy' '⭕ SilverViolet' '⭕ Velvet' '⭕ Abstract Steel' '⭕ Cushion Orange' '⭕ Cushion Gray' '⭕ Cushion Bluey' '⭕ Marbles' '⭕ BloodyCushion' '🔶 Exit' )
